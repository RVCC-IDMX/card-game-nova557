...
const text = documnet.query.Selector(".text")
...
function startGame() {
    ...
    playerDeck = new Deck(deck.cards.slice(0, dockMidpoint))
...
function flipCards() {
    ...
    const computerCard = computer.pop()
...
function updateDeckCount() {
    computerDeckElement.innerText = computer.numberOfCards
